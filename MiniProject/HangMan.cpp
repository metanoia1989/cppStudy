    ...
    do {
        ...
        if (ch2 == 'C' || ch2 == 'c') {
            ...
            if (!fin) {
                ...
                cout << "**handword.txt**\n\nLocale it, the place it next to the program file.\n\n";
                system("pause");
                return 0;
            }
            for (i = 0; i < !fin.eof(); i++) {
            ...
            ifstream finn("handword.txt");
            for (i = 0; i < !finn.eof(); i++) {
                finn >> c;
        ...
        if (ch2 == 'A' || ch2 == 'a') {
            ofstream fout("handword.txt", ios::app);
            if (!fout) {
                cout << "File missing, aborting.\n\nYou are missing a file af name"
