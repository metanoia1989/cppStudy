...
// int main(void)
// {
// 	char *src_str = "Grape wine wine luminous cup";
// 	std::cout << "origin string: " << src_str << std::endl;

// #ifdef _WIN32
// 	// windows default is gbk
// 	std::string dst_str = GbkToUtf8(src_str);
// 	std::cout << "gbk to utf8: " << dst_str << std::endl;

// 	std::string str_utf8 = Utf8ToGbk(dst_str.c_str());
// 	std::cout << "utf8 to gbk: " << str_utf8 << std::endl;
// #else
