...
target("event_table")
    set_kind("binary")
    add_files("event_table/*.cpp")

target("event_connect")
    set_kind("binary")
    add_files("event_connect/*.cpp")

target("event_propagation")
    set_kind("binary")
    add_files("event_propagation/*.cpp")

target("event_vetoing")
    set_kind("binary")
    add_files("event_vetoing/*.cpp")

target("identify")
    set_kind("binary")
    add_files("window_identifiers/*.cpp")