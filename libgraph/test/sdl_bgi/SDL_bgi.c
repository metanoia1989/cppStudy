...
#include "fonts/litt.h"    // SMALL_FONT
#include "fonts/sans.h"    // SANS_SERIF_FONT
#include "fonts/goth.h"    // GOTHIC_FONT
#include "fonts/scri.h"    // SCRIPT_FONT
#include "fonts/simp.h"    // SIMPLEX_FONT
#include "fonts/tscr.h"    // TRIPLEX_SCR_FONT
#include "fonts/lcom.h"    // COMPLEX_FONT
#include "fonts/euro.h"    // EUROPEAN_FONT
#include "fonts/bold.h"    // BOLD_FONT
...
void initwindow (int width, int height)
{
  ...
  if (0 != SDL_LockMutex (bgi_update_mutex)) {
