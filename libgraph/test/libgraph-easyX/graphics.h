...
/* global variables */
extern SDL_Surface *screen;   		//main drawing screen
extern SDL_Surface *Font_surface;	//font screen 
extern Uint32 _fgcolor, _bgcolor, _fontcolor;	//global color numbers
extern pid_t _pid;			//Don't bother with this 
